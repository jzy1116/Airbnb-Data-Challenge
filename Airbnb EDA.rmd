...
mosaicplot(~ interactions + message_length_in_char + successful_booking, data = df, color = TRUE)
#mosaicplot(~ interactions + reply_t_in_m + successful_booking, data = df, cex.axis = 0.85, color = TRUE)
mosaicplot(~ interactions + duration_of_stay + successful_booking, data = df, color = TRUE)
mosaicplot(~ lead_time_in_days + interactions + successful_booking, data = df, color = TRUE)
